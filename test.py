...
# ส่วนของการรับ input จาก command line
if __name__ == "__main__":
    init_chat()  # เริ่มการสนทนาใหม่
    print("ยินดีต้อนรับ! พิมพ์ 'reset' เพื่อรีเซ็ต หรือ 'สรุปเมนู' เพื่อดูรายการที่สั่ง")
    ...
    while True:
        ...
        if user_input.lower() == 'exit':
            print("ออกจากโปรแกรม")
            break
        response = chat_with_text(user_input)
        print(response)